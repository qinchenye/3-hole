...
def compute_Aw_main(ANi,ACu,epCu,epNi,tpd,tpp,tz,pds,pdp,pps,ppp,Upp,\
                    d_double,p_double,double_part, idx, hole3_part, hole4_part,U, S_val, Sz_val, AorB_sym):  
    if Norb==7:
    ...
    if Norb==7 or Norb==9 or Norb==10 or Norb==11:     
        Hint = ham.create_interaction_matrix_ALL_syms(VS,d_double,p_double,double_part, idx, hole3_part, hole4_part, \
                                                      S_val, Sz_val,AorB_sym,S2_val, Sz2_val,AorB2_sym, ACu, ANi, Upp)
...
#     basis.count_VS(VS)
    ...
    d_double, p_double, double_part, idx, hole3_part, hole4_part = ham.get_double_occu_list(VS)
    ...
    if pam.basis_change_type=='all_states':
        ...
        U, S_val, Sz_val, AorB_sym, S2_val, Sz2_val, AorB2_sym = basis.create_singlet_triplet_basis_change_matrix_d_double \
                                    (VS, d_double, double_part, idx, hole3_part, hole4_part)
                                ...
                                for tpp in pam.tpps:
                                    for Upp in pam.Upps:
                                        ...
                                        compute_Aw_main(ANi,ACu,epCu,epNi,tpd,tpp,tz,0,0,0,0,Upp,\
                                                        d_double,p_double,double_part, idx, hole3_part, hole4_part,U, \
