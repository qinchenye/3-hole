...
#         itype = start_state['type']
        ...
        if ((o1 not in pam.Ni_orbs) or (o1 not in pam.Cu_orbs)):
            assert(o1 in pam.O_orbs)
            s1=s2; s2=s3; o1=o2; o2=o3; idx=1
            Lspin=s1; Lorb=o1; Lpos=[x1, y1, z1]
        elif ((o2 not in pam.Ni_orbs) or (o2 not in pam.Cu_orbs)):
            assert(o2 in pam.O_orbs)
            s2=s3; o2=o3; idx=2
            Lspin=s2; Lorb=o2; Lpos=[x2, y2, z2]
        elif ((o3 not in pam.Ni_orbs) or (o3 not in pam.Cu_orbs)):
