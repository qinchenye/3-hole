...
def get_ground_state(matrix, VS, S_val,Sz_val,tz):  
    '''
    ...
    for k in range(0,1):                                                                          #gai
        ...
        for i in range(0,len(vecs[:,k])):
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==1 and z3==1 and z4==0 and S12==0:
                wgt_d8Ld10L[0]+=abs(vecs[i,k])**2                      
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==1 and z3==1 and z4==0 and S12==1:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==0 and z3==1 and z4==0 and S12==0:
                wgt_d10Ld8L[0]+=abs(vecs[i,k])**2                      
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==0 and z3==1 and z4==0 and S12==1:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==1 and z3==z4==0 and S12==0:
                wgt_d8d10L2[0]+=abs(vecs[i,k])**2                      
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==1 and z3==z4==0 and S12==1:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==0 and z3==z4==0 and S12==0:
                wgt_d10d8L2[0]+=abs(vecs[i,k])**2                      
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==0 and z3==z4==0 and S12==1:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==1 and z3==z4==1 and S12==0:
                wgt_d8L2d10[0]+=abs(vecs[i,k])**2                      
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==1 and z3==z4==1 and S12==1:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==0 and z3==z4==1 and S12==0:
                wgt_d10L2d8[0]+=abs(vecs[i,k])**2                      
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==z2==0 and z3==z4==1 and S12==1:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==1 and z2==0 and z3==z4==1 and S12==0:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==1 and z2==0 and z3==z4==0 and S12==0:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  (orb3=='px' or orb3=='py') \
                      and (orb4=='px' or orb4=='py') and z1==1 and z2==0 and z3==1 and z4==0 and S12==0:
            ...
            if orb1=='dx2y2' and orb2=='d3z2r2'  and  orb3=='d3z2r2'\
                      and (orb4=='px' or orb4=='py') and z1==1 and z2==z3==z4==0  and S12==0:
            ...
            if orb1=='d3z2r2' and orb2=='d3z2r2'  and  orb3=='dx2y2'\
                      and (orb4=='px' or orb4=='py') and z1==1 and z2==z3==z4==0  and S12==1:
            ...
            if orb1=='dx2y2' and orb2=='d3z2r2'  and  orb3=='d3z2r2'\
                      and (orb4=='px' or orb4=='py') and z1==z4==1 and z2==z3==0  and S12==0:
            ...
            if orb1=='d3z2r2' and orb2=='d3z2r2'  and  orb3=='dx2y2'\
                      and (orb4=='px' or orb4=='py') and z1==z4==1 and z2==z3==0  and S12==1:
            ...
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  orb3=='d3z2r2'\
                      and (orb4=='px' or orb4=='py') and z1==z2==z4==1 and z3==0  and S12==0:
                wgt_d8Ld9[0]+=abs(vecs[i,k])**2                       
            if orb1=='d3z2r2' and orb2=='dx2y2'  and  orb3=='d3z2r2'\
                      and (orb4=='px' or orb4=='py') and z1==z2==z4==1 and z3==0  and S12==1:
            ...
            if orb1=='dx2y2' and orb2=='dx2y2'  and orb3=='d3z2r2' and orb4=='d3z2r2'  and z1==z2==1 and z3==z4==0  and S12==0:
                wgt_d8d8[0]+=abs(vecs[i,k])**2                       
            if orb1=='d3z2r2' and orb2=='dx2y2' and orb3=='d3z2r2' and orb4=='dx2y2' and z1==z2==1 and z3==z4==0  and S12==0:
                wgt_d8d8[1]+=abs(vecs[i,k])**2     
            if orb1=='d3z2r2' and orb2=='dx2y2' and orb3=='d3z2r2' and orb4=='dx2y2' and z1==z2==1 and z3==z4==0  and S12==1:
                wgt_d8d8[2]+=abs(vecs[i,k])**2                          
            if orb1=='dx2y2' and orb2=='dx2y2'  and orb3=='dx2y2' and orb4=='dx2y2'  and z1==z2==1 and z3==z4==0  and S12==0:
                wgt_d8d8[3]+=abs(vecs[i,k])**2  
            if orb1=='d3z2r2' and orb2=='dx2y2'  and orb3=='dx2y2' and orb4=='dx2y2'  and z1==z2==1 and z3==z4==0  and S12==1:
        ...
        wgt_d9Ld9L[4]=wgt_d9Ld9L[0]+wgt_d9Ld9L[1]+wgt_d9Ld9L[2]+wgt_d9Ld9L[3]      
        ...
        wgt_d8d8[5]=wgt_d8d8[0]+wgt_d8d8[1]+wgt_d8d8[2]+wgt_d8d8[3]+wgt_d8d8[4]
        
        
#         txt=open('d10d10','a')                                  
#         txt.write(str(wgt_d10d10[0])+str(tz)+'\n')
#         txt.close()     
...
#         txt.close() 
#         txt=open('d9Ld10L2','a')                                  
#         txt.write(str(wgt_d9Ld10L2[2])+str(tz)+'\n')
#         txt.close()         
...
#         txt.close()
#         txt=open('d9d10L3','a')                                  
#         txt.write(str(wgt_d9d10L3[2])+str(tz)+'\n')
#         txt.close()        
...
#         txt.close()
#         txt=open('d9L2d10L','a')                                  
#         txt.write(str(wgt_d9L2d10L[2])+str(tz)+'\n')
#         txt.close()        
...
#         txt.close()
#         txt=open('d10Ld9L2','a')                                  
#         txt.write(str(wgt_d10Ld9L2[2])+str(tz)+'\n')
#         txt.close()        
...
#         txt.close()    
#         txt=open('d10d9L3','a')                                  
#         txt.write(str(wgt_d10d9L3[2])+str(tz)+'\n')
#         txt.close()         
...
#         txt.close()   
#         txt=open('d10L2d9L','a')                                  
#         txt.write(str(wgt_d10L2d9L[2])+str(tz)+'\n')
#         txt.close()          
...
#         txt.close()        
#         txt=open('d8Ld10L','a')                                  
#         txt.write(str(wgt_d8Ld10L[4])+str(tz)+'\n')
#         txt.close()              
...
#         txt.close()          
#         txt=open('d10Ld8L','a')                                  
#         txt.write(str(wgt_d10Ld8L[4])+str(tz)+'\n')
#         txt.close()               
...
#         txt.close()          
#         txt=open('d8d10L2','a')                                  
#         txt.write(str(wgt_d8d10L2[4])+str(tz)+'\n')
#         txt.close()         
...
#         txt.close()          
#         txt=open('d10d8L2','a')                                  
#         txt.write(str(wgt_d10d8L2[4])+str(tz)+'\n')
#         txt.close()         
...
#         txt.close()         
#         txt=open('d8L2d10','a')                                  
#         txt.write(str(wgt_d8L2d10[4])+str(tz)+'\n')
#         txt.close()         
...
#         txt.close()         
#         txt=open('d10L2d8','a')                                  
#         txt.write(str(wgt_d10L2d8[4])+str(tz)+'\n')
#         txt.close()         
...
#         txt.close()           
#         txt=open('d9L2d9','a')                                  
#         txt.write(str(wgt_d9L2d9[4])+str(tz)+'\n')
#         txt.close()           
...
#         txt.close()              
#         txt=open('d9d9L2','a')                                  
#         txt.write(str(wgt_d9d9L2[4])+str(tz)+'\n')
#         txt.close()           
...
#         txt.close()                 
#         txt=open('d9Ld9L','a')                                  
#         txt.write(str(wgt_d9Ld9L[4])+str(tz)+'\n')
#         txt.close()      
...
#         txt.close()  
#         txt=open('d9d8L','a')                                  
#         txt.write(str(wgt_d9d8L[7])+str(tz)+'\n')
#         txt.close()          
...
#         txt.close()  
#         txt=open('d8d9L','a')                                  
#         txt.write(str(wgt_d8d9L[7])+str(tz)+'\n')
#         txt.close()                 
...
#         txt.close() 
#         txt=open('d9Ld8','a')                                  
#         txt.write(str(wgt_d9Ld8[7])+str(tz)+'\n')
#         txt.close()         
...
#         txt.close() 
#         txt=open('d8Ld9','a')                                  
#         txt.write(str(wgt_d8Ld9[7])+str(tz)+'\n')
#         txt.close()    
...
#         txt.close()        
#         txt=open('d8d8','a')                                  
#         txt.write(str(wgt_d8d8[5])+str(tz)+'\n')
#         txt.close()    
        ...
        sumweight_picture=wgt_d10d10[0]+wgt_d9Ld10L2[2]+wgt_d9d10L3[2]+wgt_d9L2d10L[2]+wgt_d10Ld9L2[2]+wgt_d10d9L3[2]+wgt_d10L2d9L[2]\
                          ...
                          +wgt_d9L2d9[4]+wgt_d9d9L2[4]+wgt_d9Ld9L[4]+wgt_d9d8L[7]+wgt_d8d9L[7]+wgt_d9Ld8[7]+wgt_d8Ld9[7]+ wgt_d8d8[5]       
